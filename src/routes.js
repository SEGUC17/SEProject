...
router.post('/student/viewreviews',function(req,res){
  StudentController.ViewReviews(req,res,(err,reviews,type)=>{
    if(type=="ERROR"){
      res.json({
        type:type,
        message:reviews
...
router.post('/home/viewreg',function(req,res){
...
// router.post('/student/viewreview',function())
